...
describe('calculateBusinessHours', () => {
    ...
    it('calculates hours on the same day without lunch overlap', () => { // 10:00 to 11:30 = 1.5 hours
        const result = calculateBusinessHours('2026-03-03T10:00:00', '2026-03-03T11:30:00', config);
        expect(result).toBeCloseTo(1.5);
    });

    it('calculates hours on the same day with lunch overlap', () => { // 10:00 to 14:00 -> 10-12 (2h) + 13-14 (1h) = 3 hours
