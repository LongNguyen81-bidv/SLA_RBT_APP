...
import type {Loan, StepProgress, SLAStep}
from '../types';
...
export default function LoanDetailPanel({loan, progress, SLA_STEPS, TOTAL_INTERNAL_HOURS} : LoanDetailPanelProps) {
    ...
    const canEditDocs = loan.createdBy === user ?. id || user ?. role === 'ADMIN';
    ...
    return (
        <div> {/* Loan header info */}
            ...
            {/* Documents section */}
            <div className="mt-6 pt-4 border-t border-[#E5F0ED]">
