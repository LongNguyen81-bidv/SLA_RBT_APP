...
function SLAStepRowItem({ step, external }: SLAStepRowItemProps) {
  return (
...
export default function SLAConfigPanel({ SLA_STEPS, TOTAL_INTERNAL_HOURS }: SLAConfigPanelProps) {
